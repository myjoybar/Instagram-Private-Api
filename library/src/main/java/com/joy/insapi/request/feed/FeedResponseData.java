package com.joy.insapi.request.feed;
	...
	public static class ItemsBean {
		...
		public static class ImageVersions2Bean {
			...
			public static class CandidatesBean {
				 ...
				 * width : 434
				 * height : 434
				 * url : https://scontent-lax3-2.cdninstagram.com/vp/c890b3be0129ddf390a2507a9a74dae6/5D498601/t51
		...
		public static class LocationBean {
			 ...
			 * address :
			 * city :
			 * short_name : Tianducheng
			 * lng : 120.16666666667
			 * lat : 30.25
			 * external_source : facebook_places
			 * facebook_places_id : 581020678612884
			 */
		...
		public static class LikersBean {
			 ...
			 * profile_pic_id : 1950288130608645223_10018260970
			 * is_verified : false
			 */
			...
			public String toString() {
				return "LikersBean{" + "pk=" + pk + ", username='" + username + '\'' + ", full_name='" + full_name + '\'' + ", is_private=" + is_private + ", profile_pic_url='" + profile_pic_url + '\'' + ", profile_pic_id='" + profile_pic_id + '\'' + ", is_verified=" + is_verified + '}';
			}
		}
		...
		public static class FacepileTopLikersBean {
			 ...
			 * full_name : 大嘿
			 * is_private : false
			 * profile_pic_url : https://scontent-lax3-2.cdninstagram.com/vp/a54ccd53b565f2fc3d1ed819afb179f9/5D2DA4F4/t51
			 * .2885-19/s150x150/24254630_804278533088488_2262600939175149568_n.jpg?_nc_ht=scontent-lax3-2.cdninstagram.com
			 * profile_pic_id : 1662140735656332254_6664755214
			 * is_verified : false
			 */
			...
			@Override
			public String toString() {
				return "FacepileTopLikersBean{" + "pk=" + pk + ", username='" + username + '\'' + ", full_name='" + full_name + '\'' + ", is_private"
						+ "=" + is_private + ", profile_pic_url='" + profile_pic_url + '\'' + ", profile_pic_id='" + profile_pic_id + '\'' + ", " +
