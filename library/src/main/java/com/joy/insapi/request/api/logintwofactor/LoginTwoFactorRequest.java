...
public class LoginTwoFactorRequest extends
    InsBasePostRequest<LoginTwoFactorPayload, LoginResponseData> {
  ...
  public LoginTwoFactorRequest(String userName, String pwd, String twoFactorIdentifier,
