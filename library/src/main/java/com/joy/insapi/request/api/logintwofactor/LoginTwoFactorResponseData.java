...
public class LoginTwoFactorResponseData extends InsBaseResponseData {
   ...
   * "selfie_sticker":0},"allow_contacts_sync":false,"phone_number":""} status : ok
   */
  ...
  public static class LoggedInUserBean {
    ...
    /**
     * pk : 10171477409 username : joy.dingtone full_name : Joy is_private : false profile_pic_url :
     * https://instagram.fjed2-2.fna.fbcdn.net/vp/a926e27e7b76da4a02f480a6897aff11/5D2CF3F1/t51
     * .2885-19/44884218_345707102882519_2446069589734326272_n.jpg?_nc_ht=instagram.fjed2-2.fna.fbcdn.net
     * is_verified : false has_anonymous_profile_picture : true can_boost_post : false is_business :
     * false account_type : 1 is_call_to_action_enabled : null can_see_organic_insights : false
     * show_insights_terms : false reel_auto_archive : unset has_placed_orders : false
     * allowed_commenter_type : any nametag : {"mode":1,"gradient":0,"emoji":"😀","selfie_sticker":0}
     * allow_contacts_sync : false phone_number :
     */
    ...
    @Override
    public String toString() {
      return "LoggedInUserBean{" + "pk=" + pk + ", username='" + username + '\'' + ", full_name='"
          + full_name + '\'' + ", is_private=" + is_private + ", profile_pic_url='"
          + profile_pic_url + '\'' + ", is_verified=" + is_verified
          + ", has_anonymous_profile_picture=" + has_anonymous_profile_picture + ", can_boost_post="
          + can_boost_post + ", is_business=" + is_business + ", account_type=" + account_type
          + ", is_call_to_action_enabled=" + is_call_to_action_enabled
          + ", can_see_organic_insights=" + can_see_organic_insights + ", show_insights_terms="
          + show_insights_terms + ", reel_auto_archive='" + reel_auto_archive + '\''
          + ", has_placed_orders=" + has_placed_orders + ", allowed_commenter_type='"
          + allowed_commenter_type + '\'' + ", nametag=" + nametag.toString()
          + ", allow_contacts_sync=" + allow_contacts_sync + ", phone_number='" + phone_number
          + '\'' + '}';
    }
    ...
    public static class NametagBean {
      ...
      /**
       * mode : 1 gradient : 0 emoji : 😀 selfie_sticker : 0
       */
      ...
      @Override
      public String toString() {
        return "NametagBean{" + "mode=" + mode + ", gradient=" + gradient + ", emoji='" + emoji
